...
<div class="container-fluid">
    <div class="row page-titles mx-0">
        ...
        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            ...
            <div class="text-right"><a href="{!! url('/administrador/categoriaLocalA/create'); !!}" class="btn btn-primary ">Agregar Categoría</a></div>
        </div>
    </div>
    <!-- row -->
                        ...
                        <table id="example5" class="display" style="min-width: 845px">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a href="{!! url('/Administrador/categoriaLocalA/edit'); !!}" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
