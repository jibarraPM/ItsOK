                        ...
                        <table id="example3" class="display" style="min-width: 845px">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('restauranteD.destroy',$item->id) }}" method="POST">   
                                            <div class="d-flex">
                                                <a href="{{ route('restauranteD.show',$item->id) }}" class="btn btn-info shadow btn-xs sharp mr-1"><i class="fa fa-info"></i></a>
                                                <a href="{{ route('restauranteD.edit',$item->id) }}" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
                                                @csrf
                                                @method('DELETE')      
