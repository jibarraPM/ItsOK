                  ...
                  <div class="auth-form">
                    <x-auth-validation-errors class="mb-4" :errors="$errors" />
                      ...
                      <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group">
                          <x-label for="direccion" :value="__('Direccion')" class="mb-1"><strong>Correo</strong></x-label>
                          <x-input id="direccion" type="direccion" class="form-control" placeholder="curico, aguas negras, calle 3 casa 5" name="direccion" :value="old('direccion')" required />
                        </div>
                        <div class="form-group">
