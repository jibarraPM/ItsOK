			...
			<div class="container-fluid">
				<div class="form-head d-flex mb-3 align-items-start">
					<div class="mr-auto d-none d-lg-block">
						<h2 class="text-black font-w600 mb-0">Tickets ID #5552351</h2>
						<ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)" class="text-primary">Inicio</a></li>
                            <li class="breadcrumb-item active"><a href="javascript:void(0)">Detalle Ticket</a></li>
                        </ol>
					</div>
							...
							<div class="col-xl-12 col-lg-6 ">
								<div class="card h-auto">
									<div class="card-body text-center">
										...
										<h4 class="mb-3 text-black font-w600">Nombre Cliente</h4>
										<a href="javascript:void(0);" class="btn btn-primary light btn-xs">Cliente ID</a>
									</div>
									<div class="card bg-secondary sticky mb-0">
										<div class="card-header border-0 pb-0">
											<h5 class="card-title text-white mt-2">Nota del Pedido</h5>
										</div>
										...
										<div class="card-footer border-0 py-4 bg-warning rounded-xl">
											<div class="media align-items-center">
												...
												<div class="media-body">
													<h5 class="my-0 text-white">Dirección Envió</h5>
												</div>
											</div>
										</div>
									</div>
											...
											<ul class="timeline">
												<li>
													...
													<a class="timeline-panel text-muted" href="javascript:void(0);">
														<h4 class="mb-2">Estado Actual</h4>
														<p class="fs-15 mb-0 ">Completado</p>
													</a>
												</li>
					...
					<div class="col-xl-9 col-xxl-9 col-lg-12 col-md-12">
						<div class="row">
									...
									<div class="card-body pt-2">
										<div class="table-responsive ">
											<table class="table items-table">
												<tr>
													<th class="my-0 text-black font-w500 fs-20">Producto</th>
													<th style="width:10%;" class="my-0 text-black font-w500 fs-20">Cantidad</th>
													<th style="width:10%;" class="my-0 text-black font-w500 fs-20">Valor</th>
													<th class="my-0 text-black font-w500 fs-20">Total</th>
													<th></th>
												</tr>
												<tr>
													<td>
							...
							<div class="col-xl-12">
								<div class="card">
									<div class="card-body">
										<p class="my-0 text-black font-w500 fs-20 my-4">Personal a Cargo:</p>
										<div class="row mx-0">
											<div class="media align-items-center col-md-4 col-lg-6 px-0 mb-3 mb-md-0">
												...
												<div class="media-body">
													<h4 class="my-0 text-black">Nombre Personal</h4>
