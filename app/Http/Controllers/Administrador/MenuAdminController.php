...
class MenuAdminController extends Controller
{
    ...
    public function create(){
        ...
        return view('administrador.menu.create',compact('page_title', 'page_description','action', 'data') );
    }
    ...
    public function show(Menu $menu){
        ...
        return view('administrador.menu.show',compact('page_title', 'page_description','action', 'data') );
    }
    ...
    public function edit($id)
    {
        ...
        return view('administrador.menu.edit',compact('page_title', 'page_description','action', 'menu', 'data') );
