...
class CategoriaLocalAdminController extends Controller
{
    ...
    public function index(){
        ...
        return view('administrador.categoriaLocal.index',compact('page_title', 'page_description','action', 'data') );
    }
    ...
    public function create(){
        ...
        return view('administrador.categoriaLocal.create',compact('page_title', 'page_description','action') );
    ...
    public function edit(Request $request)
    {
        ...
        return view('administrador.categoriaLocal.edit',compact('page_title', 'page_description','action') );
