...
class UsuarioDevController extends Controller
{
    ...
    public function index(){
        ...
        return view('desarrollador.usuario.index',compact('page_title', 'page_description','action', 'data'));
    ...
    public function create(){
        ...
        return view('desarrollador.usuario.create',compact('page_title', 'page_description','action', 'data') );
    }
    ...
    public function show(Menu $menu){
        ...
        return view('desarrollador.usuario.show',compact('page_title', 'page_description','action', 'data') );
    }
    ...
    public function edit($id)
    {
        ...
        return view('desarrollador.usuario.edit',compact('page_title', 'page_description','action', 'menu', 'data') );
