...
class AgregadoDevController extends Controller
{
    ...
    public function index(){
        ...
        return view('desarrollador.agregado.index',compact('page_title', 'page_description','action') );
    }
    ...
    public function create(){
        ...
        return view('desarrollador.agregado.create',compact('page_title', 'page_description','action') );
    }
