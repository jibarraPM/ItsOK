...
class CategoriaLocalDevController extends Controller
{
    ...
    public function index(){
        ...
        return view('desarrollador.categoriaLocal.index',compact('page_title', 'page_description','action', 'data') );
    }
    ...
    public function create(){
        ...
        return view('desarrollador.categoriaLocal.create',compact('page_title', 'page_description','action') );
    ...
    public function edit(Request $request)
    {
        ...
        return view('desarrollador.categoriaLocal.edit',compact('page_title', 'page_description','action') );
